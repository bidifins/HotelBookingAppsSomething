...
public class Hotel4Fragment extends Fragment {

    public Hotel4Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_hotel4, container, false);
        ...
        btnHotel1.setOnClickListener(v -> {
            ...
            bundle.putString("hotelName", "Amanjiwo");
