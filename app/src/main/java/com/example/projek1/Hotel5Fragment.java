...
public class Hotel5Fragment extends Fragment {

    public Hotel5Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_hotel5, container, false);
        ...
        btnHotel1.setOnClickListener(v -> {
            ...
            bundle.putString("hotelName", "Alila Purnama");
